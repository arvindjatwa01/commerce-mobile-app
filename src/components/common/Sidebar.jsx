...
function Sidebar({ isOpen }) {
  return (
    <div
      className={`fixed top-0 left-0 h-screen w-64 md:static bg-purple-600 text-white transform ${
    ...
    >
      ...
      <nav className="flex flex-col space-y-4 p-4">
        <a href="/" className="flex items-center space-x-2 hover:bg-purple-700 p-2 rounded">
          <HomeIcon className="h-6 w-6" />
          <span>Home</span>
        </a>
        <a href="/about" className="flex items-center space-x-2 hover:bg-purple-700 p-2 rounded">
          <InfoIcon className="h-6 w-6" />
          <span>About</span>
        </a>
        <a href="/contact" className="flex items-center space-x-2 hover:bg-purple-700 p-2 rounded">
